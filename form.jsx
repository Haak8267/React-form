...
export default function Form() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-slate-50 to-slate-200 flex items-center justify-center p-6">
      <form className="bg-slate-150 rounded-2xl shadow-2xl p-8 w-full max-w-2xl space-y-6 transition-all duration-300 ">
        <h2 className="text-3xl font-semibold text-blue-900 text-center">Contact Us</h2>
        <div>
        ...
        <div>
          <label className="block text-sm font-medium text-blue-600">Message</label>
          <textarea
        ...
        onClick={handleSubmit}
          type="submit"
          className="w-1/2  bg-blue-500 text-white font-medium py-3  rounded-xl hover:bg-indigo-700 shadow-md transition ">
          Submit
        </button>
        </div>
      </form>
